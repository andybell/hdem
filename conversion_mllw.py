...
try:
	...
	#todo: add MHW_surface as a parameter, also need to add to tool interface
	...
	for feature in fcList:
		if check_fieldnames(feature) == True:
			...
			elif feature.fieldexists() == "MHW_m":
